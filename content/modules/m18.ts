...
/* =============================================================
   Contenu du Module 18 — Graham (4/4) : payer le juste prix
   ...
   conversion numérique de M03 et M12 (reformuler en QCM à choix
   ...
   choix unique (mécanisme `options` par question, comme M12/M13).
   ...
   **gras**, même convention que m08/m12/m13.
   ...
   transition de fin de phase déjà vue en M04/M19.
   ============================================================= */
export const m18: Module = {
  ...
  slides: [
    ...
    },
    {
      ...
      blocks: [
        { kind: "text", value: "Le **PER** (Price Earning Ratio) reprend l'image de la boutique (M12) : **PER = prix ÷ bénéfice par action**. C'est le nombre d'années de bénéfices pour récupérer votre mise." },
        {
          kind: "list",
          items: [
    ...
    },
    {
      ...
      blocks: [
        { kind: "text", value: "Un prix bas ne vaut **que** s'il s'ajoute à la performance (M16) et aux perspectives (M17) :" },
        {
          kind: "list",
          items: [
