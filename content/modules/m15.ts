...
/* =============================================================
   Contenu du Module 15 — Graham (1/4) : le portrait de l'entreprise.
   Premier des 4 modules du bloc Graham (M15-M18) + capstone M19 —
   « le cœur » de la formation. Titre du .txt sans le préfixe « M15 — »
   ...
   documenté car les 4 modules suivants (M16-M19) ont chacun un
   ...
   triplet de boutons (mécanisme M03/M09/M12/M13).
   ...
   explication, même convention que M04/M13/M14 (jamais une 4ᵉ entrée
